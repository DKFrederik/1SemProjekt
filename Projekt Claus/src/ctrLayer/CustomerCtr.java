...
public class CustomerCtr
{
    ...
    public Craftsman findCraftsman(String id)
    {
        if(cCon.findCustomer(id)instanceof Craftsman) {
            return (Craftsman)cCon.findCustomer(id);
        }
        else {
     ...
     */
    public void createCustomer(String firstName, String lastName, String address, String phone, String customerId)
    {
        Customer c = new Customer(firstName, lastName, address, phone, customerId);
        cCon.addCustomer(c);
    }
     ...
     * @param customerId A customer ID to be added
     */
    public void createCraftsman(String firstName, String lastName, String address, String phone, String customerId)
    {
        Craftsman cm = new Craftsman(firstName, lastName, address, phone, customerId);
        cCon.addCustomer(cm);
    }
