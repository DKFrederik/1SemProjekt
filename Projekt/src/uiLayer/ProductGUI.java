...
public class ProductGUI extends JFrame {
	...
	public ProductGUI() {
		...
		pCtr = new ProductCtr();
		pCtr.createProduct("Søm", "1", "asdf", 12.20, 20.00, 12, 5);
		pCtr.createProduct("Hammer", "2", "asdf", 20.00, 40.00, 63, 5);
		pCtr.createProduct("Hjul", "3", "asdf", 41.30, 50.00, 123, 5);
		pCtr.createProduct("Reb", "4", "asdf", 64.30, 60.00, 7, 5);
		...
		txtName.setBounds(136, 11, 263, 20);
		...
		txtDescription.setBounds(136, 61, 263, 20);
		...
		txtPurchasePrice.setBounds(136, 86, 263, 20);
		...
		txtSalesPrice.setBounds(136, 111, 263, 20);
		...
		txtQuantity.setBounds(135, 136, 263, 20);
		...
		txtQuantityDiscount.setBounds(136, 161, 263, 20);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(txtName.getText().length() > 0)
				{
					...
					lblErrorMsg.setText("Enter name.");
				}
			}
		});
	...
	{
		try {
			pCtr.deleteProduct(pCtr.findItem(txtName.getText()));
	...
	{
		try {
			txtName.setText(pCtr.findItem(txtName.getText()).getName());
			txtId.setText(pCtr.findItem(txtName.getText()).getId());
			txtDescription.setText(pCtr.findItem(txtName.getText()).getDescription());
			txtPurchasePrice.setText(Double.toString(pCtr.findItem(txtName.getText()).getPurchasePrice()));
			txtSalesPrice.setText(Double.toString(pCtr.findItem(txtName.getText()).getSalesPrice()));
			txtQuantity.setText(Integer.toString(pCtr.findItem(txtName.getText()).getQuantity()));
			txtQuantityDiscount.setText(Integer.toString(pCtr.findItem(txtName.getText()).getQuantityDiscount()));
		}
		catch(NullPointerException e) {
			lblErrorMsg.setText("Product not found.");
		}
